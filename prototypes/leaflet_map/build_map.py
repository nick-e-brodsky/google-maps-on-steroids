...
<style>
  ...
  .filters .filter-search {{
    display: block; width: 100%; box-sizing: border-box; margin: 2px 0 6px;
    padding: 4px 6px; font-size: 12px; border: 1px solid #ccc; border-radius: 4px;
  }}
...
<script>
  ...
  function buildFilterGroup(title, items, activeSet, colorFor) {{
    ...
    if (items.length > FILTER_SEARCH_THRESHOLD) {{
